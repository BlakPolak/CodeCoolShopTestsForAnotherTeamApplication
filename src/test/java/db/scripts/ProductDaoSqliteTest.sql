...
INSERT INTO `suppliers` (id,name,description) VALUES (1,'name','description'), (2,'name','description');
INSERT INTO `products` (id,name,description,price,category_id,supplier_id) VALUES (1,'name','description',22.0,1,1),
 ...
 (4,'name','description',22.0,1,2),
 (5,'name','description',22.0,2,1),
 (6,'name','description',22.0,1,1),
 (7,'name','description',22.0,1,2);

INSERT INTO `orders` (id,user_id,paid,send) VALUES (1,1,0,0),
 (2,2,0,0);

INSERT INTO `categories` (id,name,department,description) VALUES (1,'name','department','description'), (2,'name','department','description');
